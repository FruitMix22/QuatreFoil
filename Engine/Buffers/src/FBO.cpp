...
Framebuffer::Framebuffer(unsigned int width, unsigned int height, int binding)
	: m_width(width), m_height(height), m_bufferPoint(binding)
{
	CreateFBO();
}
...
{
	glBindFramebuffer(GL_FRAMEBUFFER, m_bufferPoint);
